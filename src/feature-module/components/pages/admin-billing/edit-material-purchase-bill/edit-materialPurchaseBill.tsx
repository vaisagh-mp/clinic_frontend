...
const EditMaterialPurchaseBill = () => {
  ...
  useEffect(() => {
    ...
    const fetchClinics = async () => {
      try {
        ...
        setClinics(res.data.results || res.data); // handles both {results:[]} or []
      } catch (err: any) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (id) {
        ...
        // create new bill
        await axios.post(
          "http://3.109.62.26/api/billing/admin/material-purchase/",
          formData,
          {
            headers: {
              Authorization: `Bearer ${token}`,
      ...
      navigate(all_routes.materialpurchasebillList);
    } catch (error: any) {
            ...
            <div className="card">
              <div className="card-body">
                <h5 className="offcanvas-title fs-18 fw-bold mb-3">
                  {id ? "Edit Material Purchase Bill" : "Add Material Purchase Bill"}
                </h5>
...
export default EditMaterialPurchaseBill;
