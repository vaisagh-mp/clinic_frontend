...
const MaterialPurchaseBills = () => {
  ...
  useEffect(() => {
    ...
    const fetchBills = async () => {
      try {
        const res = await api.get("billing/admin/material-purchase/", {
...
const exportExcel = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      await api.delete(`billing/admin/material-purchase/${deleteId}/`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      ...
      render: (record: any) => (
        <div className="action-item">
          ...
          <ul className="dropdown-menu p-2">
            <li>
              <Link
                to={`/edit-material-purchase-bill/${record.id}`}
...
>
            ...
            <li>
              <Link
                to={`/view-material-purchase-bill/${record.id}`}
                 className="dropdown-item d-flex align-items-center"
>
                  View
                   </Link>
