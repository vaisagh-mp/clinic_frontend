...
const LabBills = () => {
  ...
  useEffect(() => {
    ...
    const fetchBills = async () => {
      try {
        const res = await api.get("billing/admin/lab-bill/", {
  ...
  const columns = [
    ...
    {
  title: "Clinic",
  dataIndex: "clinic", // keep this for key, but we’ll override in render
