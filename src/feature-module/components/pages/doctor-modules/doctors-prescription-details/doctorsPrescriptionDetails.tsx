            ...
            <div className="col-lg-10 mx-auto">
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  {/* Prescriptions Table */}
<div className="mb-4">
  <h6 className="mb-3 fs-16 fw-semibold text-center">Prescription</h6>
    ...
    <table className="table table-nowrap">
      ...
      <tbody>
        {prescriptions.map((med: any, index: number) => {
          const isProcedureOnly = !med.medicine_name && med.procedure;
          return (
            <tr key={index}>
              <td>{(index + 1).toString().padStart(2, "0")}</td>
              <td>{isProcedureOnly ? med.procedure : med.medicine_name}</td>
              {!isProcedureOnly && (
                <>
                  <td>{med.dosage}</td>
                  <td>{med.frequency}</td>
