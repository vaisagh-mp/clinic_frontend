...
const api = axios.create({
  baseURL: "http://3.109.62.26/api/billing/clinic/",
});
...
const LabBills = () => {
  ...
  if (!data || data.length === 0) {
    alert("No lab bills available to download.");
    return;
  }
  ...
  XLSX.utils.book_append_sheet(workbook, worksheet, "Lab Bills");

  const filename = `${clinicName}_Lab_Bills.xlsx`;
  ...
  const columns = [
    ...
    },
    {
      title: "Lab Name",
      dataIndex: "lab_name",
      render: (lab_name: string) => lab_name || "N/A",
    },
    {
      title: "Total Amount",
      ...
      render: (record: any) => (
        <div className="action-item">
          ...
          <ul className="dropdown-menu p-2">
            <li>
              <Link
                to={`/clinic-dashboard/edit-lab-bill/${record.id}`}
            ...
            <li>
              <Link
                to={`/clinic-dashboard/view-lab-bill/${record.id}`}
                className="dropdown-item d-flex align-items-center"
              >
                View
              </Link>
        ...
        <div className="content">
          ...
          <div className="d-flex align-items-sm-center flex-sm-row flex-column gap-2 mb-3 pb-3 border-bottom">
            ...
            <div className="text-end d-flex">
              <Link
                to="/clinic-dashboard/add-lab-bill"
