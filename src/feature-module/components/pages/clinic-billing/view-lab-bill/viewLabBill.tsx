...
const ViewLabBill = () => {
  ...
  // ✅ Fetch Lab Bill (Clinic Endpoint)
  useEffect(() => {
              ...
              <div className="d-flex align-items-sm-center flex-sm-row flex-column mb-4">
                <div className="flex-grow-1">
                  <h6 className="fw-bold mb-0 d-flex align-items-center">
                    <Link to={all_routes.clinicpanellabbillList} className="me-1">
                ...
                <div className="card-body">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="px-3 py-2 bg-light rounded">
                      ...
                      <p className="mb-1">
                        <strong>Lab Name:</strong> {lab_name}
                      </p>
                      <p className="mb-1">
                        <strong>Clinic:</strong> {bill.clinic_name || "N/A"}
                      </p>
                      <p className="mb-0">
                        <strong>Work Description:</strong> {work_description}
                      </p>
                    </div>
                  </div>
