...
//     // Append educations as individual fields
//     educations.forEach((edu, index) => {
//       Object.entries(edu).forEach(([key, value]) => {
//         formPayload.append(`educations[${index}][${key}]`, String(value));
//       });
//     });

//     // Append certifications as individual fields
//     certifications.forEach((cert, index) => {
//       Object.entries(cert).forEach(([key, value]) => {
//         formPayload.append(`certifications[${index}][${key}]`, String(value));
//       });
//     });
...
//                     <button type="button" className="btn btn-light" onClick={() => navigate(all_routes.doctors)}>
//                       Cancel
//                     </button>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="d-flex justify-content-end gap-2">
                      <button
                        ...
                        onClick={() => navigate(all_routes.clinicallDoctors)}
                      >
                        Cancel
                      </button>
                      <button type="submit" className="btn btn-primary" disabled={loading}>
