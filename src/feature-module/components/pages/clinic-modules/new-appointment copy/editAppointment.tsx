...
const NewAppointment = () => {
  ...
  format="DD-MM-YYYY" // UI still shows DD-MM-YYYY for users
  getPopupContainer={getModalContainer}
  onChange={(date) =>
    setFormData({
      ...formData,
      appointmentDate: date ? date.format("YYYY-MM-DD") : "", // send correct format
    })
  }
/>
  ...
  format="HH:mm:ss" // ensures seconds included
  onChange={(time) =>
    setFormData({
      ...formData,
      appointmentTime: time ? time.format("HH:mm:ss") : "",
    })
  }
