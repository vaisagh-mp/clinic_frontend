    ...
    try {
      await axios.put(
        `http://3.109.62.26/api/clinic/appointments/${id}/`,
        {
          ...
          clinic_id: formData.clinic, // keep in payload
                ...
                <div className="form">
                  ...
                  <div className="row">
                    ...
                    {/* <div className="col-md-4 mb-3">
                      ...
                      <select className="form-control" value={formData.clinic} disabled>
                  ...
                  <div className="row">
                    <div className="col-md-6 mb-3">
                      ...
                      <DatePicker
                        ...
                        onChange={(date) => setFormData({ ...formData, appointmentDate: date ? date.format("YYYY-MM-DD") : "" })}
                      />
                    </div>
                    ...
                    <div className="col-md-6 mb-3">
                      ...
                      <TimePicker
                        ...
                        onChange={(time) => setFormData({ ...formData, appointmentTime: time ? time.format("HH:mm:ss") : "" })}
...
export default CliniceditAppointment;
